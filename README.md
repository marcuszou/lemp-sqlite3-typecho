...
> 381e168ff409   nginx:alpine       "/docker-entrypoint.…"   About an hour ago   Up About an hour   0.0.0.0:8080->80/tcp, [::]:8080->80/tcp   web
> 0382e88e22bf   lesp-typecho-php   "docker-php-entrypoi…"   About an hour ago   Up About an hour   9000/tcp                                  php8
...
8.1 Install a certifier: `mkcert` locally:
...
8.2 Install the service, create the cert and key files:
...
8.3- Introduce SSL server by appending the following contents into `nginx/conf/default.conf` file:
...
8.4- Adding port 443 and `./devcerts/` volume into the `docker-compose.yml` file:
